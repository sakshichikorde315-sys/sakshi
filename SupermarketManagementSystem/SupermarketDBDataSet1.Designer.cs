...
namespace SupermarketManagementSystem {
    ...
    public partial class SupermarketDBDataSet1 : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductsRow AddProductsRow(int ProductID, string ProductName, string Category, decimal Price) {
...
namespace SupermarketManagementSystem.SupermarketDBDataSet1TableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Products] WHERE (([ProductID] = @Original_ProductID) AND ((@IsNull_ProductName = 1 AND [ProductName] IS NULL) OR ([ProductName] = @Original_ProductName)) AND ((@IsNull_Category = 1 AND [Category] IS NULL) OR ([Category] = @Original_Category)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([ProductID], [ProductName], [Category], [Price]) VA" +
                "LUES (@ProductID, @ProductName, @Category, @Price);\r\nSELECT ProductID, ProductNa" +
                "me, Category, Price FROM Products WHERE (ProductID = @ProductID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [ProductID] = @ProductID, [ProductName] = @ProductName, [Category] = @Category, [Price] = @Price WHERE (([ProductID] = @Original_ProductID) AND ((@IsNull_ProductName = 1 AND [ProductName] IS NULL) OR ([ProductName] = @Original_ProductName)) AND ((@IsNull_Category = 1 AND [Category] IS NULL) OR ([Category] = @Original_Category)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)));
SELECT ProductID, ProductName, Category, Price FROM Products WHERE (ProductID = @ProductID)";
        ...
        public virtual int Fill(SupermarketDBDataSet1.ProductsDataTable dataTable) {
        ...
        public virtual SupermarketDBDataSet1.ProductsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            SupermarketDBDataSet1.ProductsDataTable dataTable = new SupermarketDBDataSet1.ProductsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(SupermarketDBDataSet1.ProductsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ProductID, string Original_ProductName, string Original_Category, global::System.Nullable<decimal> Original_Price) {
        ...
        public virtual int Insert(int ProductID, string ProductName, string Category, global::System.Nullable<decimal> Price) {
        ...
        public virtual int Update(int ProductID, string ProductName, string Category, global::System.Nullable<decimal> Price, int Original_ProductID, string Original_ProductName, string Original_Category, global::System.Nullable<decimal> Original_Price) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ProductName, string Category, global::System.Nullable<decimal> Price, int Original_ProductID, string Original_ProductName, string Original_Category, global::System.Nullable<decimal> Original_Price) {
            return this.Update(Original_ProductID, ProductName, Category, Price, Original_ProductID, Original_ProductName, Original_Category, Original_Price);
        }
    }
